...
## We need a needle to drop.
# We can see fairly easily that the y-coordinate of the needle doesn't actually
# matter, since we assumed the lines to of infinite length.
...
## Example run with distance between the lines of 1 and needle length of 1.
